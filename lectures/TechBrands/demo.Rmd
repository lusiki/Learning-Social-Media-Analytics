...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block4"> Reach </button>  
<div id="Block4" class="collapse">


```{r landscapeFreqBrand, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 9, fig.width=9}
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block5"> Reach </button>  
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block6"> Engagement </button>  
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block8"> PRVrijednost </button>  
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block9"> Viralnost </button>  
