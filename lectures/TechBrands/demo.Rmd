...
```{r echo = FALSE, message=FALSE,warning=FALSE, fig.height = 12, fig.width = 15,fig.cap="Grafikon: Broj objava za medij i brand u cjelom razdoblju."}
...
```{r landscapeFreqBrand, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 15, fig.width=12}
