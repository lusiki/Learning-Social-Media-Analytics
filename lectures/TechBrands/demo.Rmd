...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block7"> Grafikon: Broj objava po domenama prema kriteriju PR vrijednosti. </button>  
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block8"> Grafikon: Broj objava po domenama prema kriteriju viralnosti. </button>  
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block11"> Tablica: Najčešće riječi na YouTubee o brandu Bosch. </button>  
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block12"> Tablica: Najčešće riječi na forumima o brandu Phillips. </button>  
