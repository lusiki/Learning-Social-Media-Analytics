...
```{r frekvencija, message=F, warning=F, fig.height=10, fig.width=12}
...
```{r eval = F,message=F, warning=F, fig.height=12, fig.width=12}
...
```{r TEME, message=F, warning=F, fig.height=12, fig.width=12}
fb_tokenTidy_TopLike %>%
