...
# Function to calculate cumulative count and percentage for top N factors
summarize_top_n <- function(data, n) {
    top_n <- head(data, n)
    list(
        Total_Count = sum(top_n$Count),
        Total_Percentage = sum(top_n$Percentage)
    )
}

# Calculate for top 10, 20, 50, and 100
top_10 <- summarize_top_n(result, 10)
top_20 <- summarize_top_n(result, 20)
top_50 <- summarize_top_n(result, 50)
top_100 <- summarize_top_n(result, 100)
...
variables <- read.xlsx("C:/Users/lukas/Desktop/Native.xlsx", sheetIndex = 1)
>>>>>>> 23951cf33a10b58d363b43f6cce8b6122bf3a806
...
CroSentilex_p  <- read.delim("C:/Users/lukas/Desktop/Mislav@Luka/crosentilex-positives.txt",
                                   header = FALSE,
                                   sep = " ",
                                   stringsAsFactors = FALSE,
                                   fileEncoding = "UTF-8") %>%
...
CroSentilex_Gold  <- read.delim2("C:/Users/lukas/Desktop/Mislav@Luka/gs-sentiment-annotations.txt",
                                 header = FALSE,
                                 sep = " ",
                                 stringsAsFactors = FALSE) %>%
                    rename(word = "V1", sentiment = "V2" ) 
...
LilaHR  <- read_excel("C:/Users/lukas/Desktop/Mislav@Luka/lilaHR_clean.xlsx", sheet = "Sheet1") %>% select (-"...1")
LilaHR_long <- read_excel("C:/Users/lukas/Desktop/Mislav@Luka/lilaHR_clean_long.xlsx", sheet = "Sheet1") %>% select (-"...1") 
