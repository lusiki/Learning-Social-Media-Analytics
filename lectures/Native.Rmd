...
#  scale_fill_discrete(name = "Sentiment")+
  scale_fill_manual(values = c("grey10", "grey30", "grey50", "grey70"), name = "Sentiment") +  # Assuming two sentiment values; adjust as needed
  theme(
...
ggplot(., aes(x = factor(SENTIMENT), y = BrojObjava, fill = factor(SENTIMENT))) +
  ...
  scale_fill_manual(values = c("black", "grey50", "grey80"), name = "Sentiment") +
  theme_minimal() +
  theme(
    axis.text.x = element_text(color = "black"),
    axis.text.y = element_text(color = "black"),
