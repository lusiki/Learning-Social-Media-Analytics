...
#### Oblak riječi sa sentimentom (za Financijsku industriju, i.e. 1); ispod toga je doprinos riječi sentimentu za industriju
```{r echo=F, eval=T, message=F , warning= FALSE}
...
#### Oblak riječi sa sentimentom (za ICT, i.e. 11)
```{r echo=F, eval=T, message=F , warning= FALSE}
...
#### Oblak riječi sa sentimentom (za Zdravlje, i.e. 6)
```{r echo=F, eval=T, message=F , warning= FALSE}
