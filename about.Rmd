...
5) Application of key priniples, tools and methods for independent social media research
c
...
<br>
Unofficial course syllabus can be downloaded here(check for updates).
