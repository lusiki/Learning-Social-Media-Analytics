...
Izvještaj sadržava pregled hrvatskog medijskog prostora za četiri konkurenta **Bosch, Braun, Phillips, Dyson**. Pregled se odnosi na sve medijske objave koje sadrže naziv branda (konkurenta) u **razdoblju od tri mjeseca** (2021/10/06 do 2022/01/06). Objave uključuju sve hrvatske društvene medije: *web, facebook, youtube, twitter, instagram, forum, reddit i komentare*. U prvom dijelu izvještaja je skupno prikazan cjeli medijski prostor. Nakon toga su opisani najrelevantniji mediji, a potom sadržaj objava za odabrane brandove. Na kraju su istaknuti najvažniji zaključci.



# **Cjeli medijski prostor**
...
<br>
 ...
 U cjelokupnom  medijskom prostoru je u analiziranom periodu bilo ukupno 2677 objava o četiri konkurenta, odnosno `r avg` objava dnevno. Pri tome najveću prisutnost ima brand Bosch, nakon čega slijede Braun i Phillips, a na kraju Dyson. 
